        ...
        <main>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" method="post" action="handleaddreservationtouser.php"
                        enctype="multipart/form-data">

                        <div class="row g-3">
                            <div class="col-12">
                                <label for="Plate-Id" class="form-label">Your_email</label>
                            ...
                            <div class="col-12">
                                <div class="input-group has-validation">
                                    <input hidden type="number" class="form-control" id="Car_id" name="car_id"
                                        placeholder="" value="<?= $car['car_id'] ?>" readonly>
                                    
                                </div>
                            </div>
                            <div class="col-12">
                                <input hidden type="number" class="form-control" id="office_Id" name="office_Id" placeholder=""
                                value="<?= $car['office_Id'] ?>"
                                    readonly>
                            </div>
                            <div class="">
