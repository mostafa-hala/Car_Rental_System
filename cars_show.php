...
<body>
  ...
  <div class="d-flex gap-2 justify-content-center py-3">
    ...
    <button class="btn btn-success rounded-pill px-3" type="button"><a href="add_car.php" style="text-decoration: none;color:#ffffff">ADD</a></button>
    <button class="btn btn-danger rounded-pill px-3" type="button"><a href="MODIFY.php" style="text-decoration: none;color:#ffffff">MODIFICATION</a></button>
