...
$data = isset($_SESSION['reservation_specicfic']) ? $_SESSION['reservation_specicfic'] : array();
?>
<!doctype html>
    ...
    <main>
      ...
      <div class="d-flex justify-content-around ">
          ...
          <form class="needs-validation" method="post" action="handleaddcar.php" enctype="multipart/form-data">
              ...
              <div class="">
                ...
                <div class="input-group has-validation">
                  <input type="email" class="form-control" id="email" value="<?= $reservation['email'] ?>" readonly>

                </div>
                <div class="">
                  <label for="Car_id" class="form-label">Car_id</label>
                  <div class="input-group has-validation">
                    <input type="number" class="form-control" id="" value="<?= $reservation['car_id'] ?>" readonly>
                ...
                <div class="">
                  <label for="Car_id" class="form-label">Cust_id</label>
                  <div class="input-group has-validation">
                    <input type="number" class="form-control" id="" value="<?= $reservation['customer_id'] ?>" readonly>
                    <div class="invalid-feedback">
                      Your brand is required.
                    </div>
                  </div>
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control" id=""  value="<?= $reservation['reservation_date'] ?>" readonly>
                  <div class="invalid-feedback">
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control" id="pickup_date"  value="<?= $reservation['pickup_date'] ?>" readonly>
                  <div class="invalid-feedback">
                    Please enter a color
                  </div>
                </div>
                <div class="">
                  ...
                  <input type="text" class="form-control" id="return_date"  value="<?= $reservation['return_date'] ?>" readonly>
                  <div class="invalid-feedback">
                    Please enter a color
                  </div>
                </div>
                ...
                <div class="">
                  ...
                  <input type="text" class="form-control" id="Payment_Status" value="<?= $reservation['payment_status'] ?>" readonly>
                  <div class="invalid-feedback">
                    Please enter a year
                  </div>
                </div>
                <div class="">
                  ...
                  <input type="text" class="form-control" id="Payment_Status" value="<?= $reservation['status'] ?>" readonly>
                  <div class="invalid-feedback">
                    Please enter a year
                  </div>
                </div>
        ...
        <div class="">
          ...
          <form class="needs-validation" method="post" action="handleeditreservation.php" >

            <div class="">
              <label for="car-Id" class="form-label">Car-Id</label>
              <div class="input-group has-validation">
                <input type="number" class="form-control" id="Car-Id" name="car_id" placeholder="car-id" required>
                <div class="invalid-feedback">
                  Your car_id is required.
                </div>
              </div>
            </div>
            <div class="">
              ...
              <?php foreach ($data as $reservation) : ?>
                ...
                <input type="hidden" class="form-control" id="customer_id" name="customer_id" value="<?= $reservation['customer_id'] ?>">
                <?php endforeach; ?>
                <!-- <div class="invalid-feedback">
            ...
            <div class="">
              ...
              <input type="number" class="form-control" id="office_Id" name="office_Id" placeholder="" required>
              <div class="invalid-feedback">
            ...
            <div class="">
              <label for="reservation_date" class="form-label">reservation_date</label>
              <div class="input-group has-validation">
                <input type="date" class="form-control" id="reservation_date" name="reservation_date" placeholder="" required>
                <div class="invalid-feedback">
                  Your brand is required.
                </div>
              </div>
            ...
            <div class="">
              <label for="pickup_date" class="form-label">pickup_date</label>
              <div class="input-group has-validation">
                <input type="date" class="form-control" id="pickup_date" name="pickup_date" placeholder="" required>
                <div class="invalid-feedback">
                  Your brand is required.
                </div>
              </div>
            ...
            <div class="">
              <label for="return_date" class="form-label">return_date</label>
              <div class="input-group has-validation">
                <input type="date" class="form-control" id="return_date" name="return_date" placeholder="" required>
                <div class="invalid-feedback">
                  Your brand is required.
                </div>
              </div>
