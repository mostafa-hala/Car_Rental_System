...
$data = isset($_SESSION['search_results_reservation']) ? $_SESSION['search_results_reservation'] : array();
?>
<!doctype html>
                        ...
                        <?php foreach ($data as $reservation) : ?>
                            <div class="col">
                                <div class="card shadow-sm">
                                    ...
                                    <?php if ($reservation["status"] == "rented") { ?>
                                    ...
                                    <?php } elseif ($reservation["status"] == "active") { ?>
                                        <button class="btn btn-success rounded-pill px-3" type="button">
                                            <a href="handle_show_specific_car_for_reservation.php?car_id=<?= $reservation['car_id'] ?>&office_Id=<?= $reservation['office_Id'] ?>" style="text-decoration: none;color:#ffffff">Reserve</a>
                                        </button>
                                    <?php } else { ?>
                                        <button class="btn btn-danger rounded-pill px-3" type="button" disabled>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><?php echo "Status: " . $reservation['payment_status']; ?></p>
